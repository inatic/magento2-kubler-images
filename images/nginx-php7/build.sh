...
_packages="dev-lang/php:${_php_slot} dev-php/xdebug dev-php/pecl-apcu_bc dev-libs/libmemcached media-gfx/imagemagick dev-php/pecl-redis pecl-imagick dev-php/pecl-memcached app-arch/zstd dev-db/mysql"
...
configure_rootfs_build()
{
    ...
    chown -R 1001:1001 "${_EMERGE_ROOT}"/home/magento
}
